...
using Saesentsessis.DOD.SoA.Generator.Installer.SimpleJSON;

namespace Saesentsessis.DOD.SoA.Generator.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/Saesentsessis.DOD.SoA.Generator.Installer.Tests/test_manifest.json";
